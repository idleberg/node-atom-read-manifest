...
function readManifestSync(packageName) {
    ...
    try {
        var fileContents = fs_1.readFileSync(filePath, 'utf8');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (packagePath) {
                        return [2 /*return*/, path_1.resolve(packagePath, 'package.json')];
                    }
                    return [4 /*yield*/, readPkgUp({ cwd: __dirname })];
                case 1:
                    packageJson = (_a.sent()).packageJson;
                    return [4 /*yield*/, resolvePackagePath(packageJson.name)];
...
function resolvePackagePathSync(packageName) {
    ...
    if (packagePath) {
        return path_1.resolve(packagePath, 'package.json');
    }
    var packageJson = readPkgUp.sync({ cwd: __dirname }).packageJson;
